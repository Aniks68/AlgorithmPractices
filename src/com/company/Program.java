...
class Program {
    static class LRUCache {
        ...
        public void insertKeyValuePair(String key, int value) {
            ...
            Map<String, Integer> LRUCMap = null;
            LRUCMap.put(key, Integer.valueOf(value));
        }
 ...
 *
 * Additionally, the LRUCache class should store a maxSize property set to the size of the cache, which is passed in as an argument during instantiation.
 * This size represents the maximum number of key-value pairs that the cache can store at once. If a key-value pair is inserted in the cache when it has reached maximum capacity, the least recently used key-value pair should be evicted from the cache and no longer retrievable; the newly added key-value pair should effectively replace it.
 *
